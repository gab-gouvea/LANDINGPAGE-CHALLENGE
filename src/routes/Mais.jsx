        ...
        <main className="about">
          <div>
            <div className="about-content">
              <div>
                <span className="text-gradient">Fórmula E</span>
                <h2>Futuro do Automobilismo</h2>
              </div>
              <p>
                Fórmula E é mais do que uma competição. É um chamado à
            ...
            <div className="about-content">
              <div>
                <span className="text-gradient">O Desafio</span>
                <h2>Proposto</h2>
              </div>
              <p>
                O Challenge FIAP é um programa de competições que oferece aos
            ...
            <div className="about-content">
              <div>
                <span className="text-gradient">Saiba Mais</span>
                <h2>Solução E-Pit</h2>
              </div>
              <p>
                O sistema E-Pit contará com uma plataforma destinada aqueles que
              ...
              <ul className="features-list">
                <li>
                  ...
                  Escolha entre os melhores pilotos da Fórmula E e personalize
                  sua estratégia de acordo com o seu estilo de jogo.
                </li>
                <li>
                  <strong>Acompanhe as corridas em tempo real:</strong>
                  Viva a emoção das corridas ao vivo ou através do E-tracker, o
                  mapa em tempo real da plataforma, e acompanhe cada ponto
                  conquistado pelos seus pilotos.
                </li>
                <li>
                  <strong>Dispute:</strong> Participe do sistema rankeado com
                  seus amigos ou desafie jogadores do mundo todo em rankings
                  globais.
                </li>
                <li>
                  <strong>Aprimore suas habilidades:</strong>
                  Analise estatísticas, estude as pistas e faça as melhores
                  escolhas para levar seu time ao topo. Progrida através de
                  acúmulos de pontos, e desbloqueie novos pilotos e
                  funcionalidades para a sua equipe.
                </li>
                <li>
                  <strong>Ganhe prêmios incríveis:</strong>
                  Dispute prêmios exclusivos nas ligas e mostre que você é o rei
                  da Fórmula E no E-Pit!
                </li>
                <li>
                  <strong>Acompanhe tudo em um só lugar:</strong>
                  Acesse todas as informações que você precisa sobre a Fórmula E
                  em um único site fácil de usar.
                </li>
                <li>
                  <strong>Fique conectado:</strong> Participe da comunidade
                  E-Pit e interaja com outros fãs da categoria.
                </li>
                <li>
                ...
                <li>
                  <strong>Replays:</strong> Reviva os momentos mais emocionantes
                  das corridas com replays completos e em alta qualidade.
                </li>
                <li>
                  <strong>Notícias:</strong> Fique por dentro de tudo o que
                  acontece no mundo da Fórmula E com notícias atualizadas em
                  tempo real.
                </li>
                <li>
                  <strong>Sustentabilidade e Inovação:</strong>
                  Explore uma seção dedicada à sustentabilidade e inovação na
                  Fórmula E, aprendendo sobre as iniciativas da categoria para
                  um futuro mais verde e tecnológico.
                </li>
              </ul>
            </div>
          </div>
